        ...
        <div class="col-sm-12" >
                ...
                while($row=$read->fetch_assoc()){
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><a href="update.php?cod_producto= <?php echo urlencode($row['cod_producto']); ?>" class="btn btn-primary btn-sm">EDITAR</a></td>
                        </tr>
                    </tbody>
                <?php }
                ?>
            ...
            <div class="form-group">
                    <label class="label label-primary">
                        ...
                        <span><a href="registro.php" class="btn btn-warning">SALIR DEL SISTEMA</a></span>
